...
import _storeImage from "../../assets/images/store.png";
...
function toAbsoluteUrl(url?: string | null) {
  console.log("DonorHall toAbsoluteUrl input:", url);
  if (!url) {
  ...
  if (/^https?:\/\//i.test(trimmed) || trimmed.startsWith("data:")) {
    console.log("Returning as-is (HTTP/HTTPS/data URL):", trimmed.substring(0, 50) + "...");
    return trimmed;
  }
    ...
    (async () => {
      try {
        ...
        const mapped = sliced.map((d, idx) => ({
          ...
          avatar: toAbsoluteUrl(d.profile_image_url) || user,
        }));
